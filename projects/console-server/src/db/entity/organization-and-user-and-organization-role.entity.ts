import {
  OrganizationAndUserAndOrganizationRoleModel,
...
export class OrganizationAndUserAndOrganizationRole extends BaseEntity implements OrganizationAndUserAndOrganizationRoleModel {
